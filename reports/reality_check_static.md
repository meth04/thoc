...
| S6 | pass | 13 điểm RNG, tất cả thuộc danh mục cho phép (thời tiết, tie-break, sinh-tử, chăn nuôi, trộm, blueprint, tin đồn, khởi tạo t0, xáo menu): engine\board.py:95:bang_rao; engine\chan_nuoi.py:20:chan_nuoi; engine\demography.py:197:tu_vong; engine\demography.py:97:sinh_con; engine\research.py:89:blueprint; engine\tick.py:155:rao_vat; engine\world.py:364:khoi_tao; engine\world.py:99:thoi_tiet; engine\xa_hoi.py:62:xa_hoi; minds\orchestrator.py:107:batch_xao; minds\prompts.py:235:menu_xao; minds\prompts.py:476:nhin_hx; minds\prompts.py:495:tin_don |
