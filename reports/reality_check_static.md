...
Mục kiểm: S,P. Điểm tự phát (S+P+D, 13 mục): **85%**.
...
| S6 | pass | 12 điểm RNG, tất cả thuộc danh mục cho phép (thời tiết, tie-break, sinh-tử, chăn nuôi, trộm, blueprint, tin đồn, khởi tạo t0, xáo menu): engine\board.py:95:bang_rao; engine\chan_nuoi.py:21:chan_nuoi; engine\demography.py:197:tu_vong; engine\demography.py:97:sinh_con; engine\research.py:89:blueprint; engine\tick.py:175:rao_vat; engine\world.py:102:thoi_tiet; engine\world.py:395:khoi_tao; engine\xa_hoi.py:62:xa_hoi; minds\prompts.py:255:menu_xao; minds\prompts.py:505:nhin_hx; minds\prompts.py:524:tin_don |
